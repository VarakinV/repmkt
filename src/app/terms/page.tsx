...
export const metadata: Metadata = {
  title: "Terms and Conditions | Real Estate Photography Growth Lab",
  description: "Terms and Conditions for Real Estate Photography Growth Lab.",
};
    ...
    <main className={styles.legalPage}>
      <div className={styles.container}>
        <div className={styles.card}>
          ...
          <span className={styles.lastUpdated}>Last updated: February 27, 2026</span>
          ...
          <ul>
            ...
            <li><p><strong>Company</strong> (referred to as either &quot;the Company&quot;, &quot;We&quot;, &quot;Us&quot; or &quot;Our&quot; in these Terms and Conditions) refers to Real Estate Photography Growth Lab.</p></li>
            ...
            <li><p><strong>Website</strong> refers to Real Estate Photography Growth Lab, accessible from <a href="https://repmkt.com/" rel="external nofollow noopener" target="_blank">https://repmkt.com/</a></p></li>
          ...
          <ul>
            <li>By visiting this page on our website: <a href="https://repmkt.com/contact" rel="external nofollow noopener" target="_blank">https://repmkt.com/contact</a></li>
          </ul>
