...
export const metadata: Metadata = {
  title: "Privacy Policy | Real Estate Photography Growth Lab",
  description: "Privacy Policy for Real Estate Photography Growth Lab.",
};
      ...
      <div className={styles.container}>
        <div className={styles.card}>
          ...
          <ul>
            ...
            <li><p><strong>Company</strong> (referred to as either &quot;the Company&quot;, &quot;We&quot;, &quot;Us&quot; or &quot;Our&quot; in this Privacy Policy) refers to Real Estate Photography Growth Lab.</p></li>
          ...
          <p>Where required by law, we use non-essential cookies only with Your consent. You can withdraw or change Your consent at any time using Our cookie preferences tool (if available) or through Your browser/device settings.</p>
          <p>We use both Session and Persistent Cookies for the purposes set out below:</p>
          <ul>
            <li>
              <p><strong>Necessary / Essential Cookies</strong></p>
              <p>Type: Session Cookies — Administered by: Us</p>
              <p>Purpose: These Cookies are essential to provide You with services available through the Website and to enable You to use some of its features.</p>
            </li>
            <li>
          ...
          <ul>
            ...
            <li><p><strong>To contact You:</strong> To contact You by email, telephone calls, SMS, or other equivalent forms of electronic communication regarding updates or informative communications related to the functionalities, products or contracted services.</p></li>
          ...
          <p>We may retain Personal Data beyond the periods stated above for the following reasons:</p>
          <ul>
